...
export function PreviewModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] bg-black/90 backdrop-blur-sm overflow-y-auto">
      ...
      <div className="bg-slate-900/90 backdrop-blur-sm border-b border-slate-700 px-6 py-4 sticky top-0 z-[10000]">
        ...
        {saveError && (
          <div className="mt-3 bg-red-500/10 border border-red-500/50 text-red-400 px-3 py-2 rounded-lg text-sm">
            {saveError}
          </div>
        )}
      </div>
