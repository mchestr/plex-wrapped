...
const coreNavItems: NavItem[] = [
  {
    ...
    label: "Overview",
    testId: "admin-nav-observability",
    icon: (
...
const primaryMobileNavItems: NavItem[] = [
  ...
  maintenanceNavItems[0], // Maintenance Overview
...
const secondaryMobileNavItems: NavItem[] = [
  ...
  ...maintenanceNavItems.slice(1), // Rules, Candidates, User Feedback, Deletion History
...
export function AdminNav() {
  ...
  const isActive = (href: string) => {
    ...
    if (href === "/admin/observability") {
      return pathname === "/admin/observability" || pathname === "/admin"
    }
    if (href === "/admin/users") {
    ...
    <>
      ...
      <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 bg-slate-900/95 backdrop-blur-sm border-r border-slate-700 z-40 flex-col">
        <div className="p-6 border-b border-slate-700">
          <Link href="/admin/observability" className="flex items-center gap-2 group">
